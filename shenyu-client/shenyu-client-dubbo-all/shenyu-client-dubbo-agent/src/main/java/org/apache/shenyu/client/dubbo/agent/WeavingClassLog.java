...
public enum WeavingClassLog {
    ...
    INSTANCE;
    private static final Logger LOG = LoggerFactory.getLogger(WeavingClassLog.class);
     ...
     */
    public void log(final TypeDescription typeDescription, final DynamicType dynamicType) {
